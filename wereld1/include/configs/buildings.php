...
$cl_builds->set_description("In the Headquarters you can construct new buildings or upgrade existing ones. The higher its level, the faster construction will finish.");
