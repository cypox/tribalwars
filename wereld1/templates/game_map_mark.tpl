		...
		<form action="game.php?village={$village.id}&amp;screen=map&amp;page=mark&amp;action=mark" method="post">
			<td valign="top" width="50%">
				<table class="vis" style="border: 1px solid #804000" align="center" width="100%">
					<tr><th colspan="3">Mark player</th></tr>
					...
					<tr><td>&raquo; Color:</td><td><input type="text" class="color" value="FF0000" maxlength="6" name="color" /></td></tr>
				</table>
			</td>
		</form>
		<td valign="top" width="50%">
			<table class="vis" style="border: 1px solid #804000;" align="center" width="100%">
				<tr><th colspan="6">Marked players:</th></tr>
				<tr class="nowrap">
