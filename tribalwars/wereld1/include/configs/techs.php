...
$cl_techs->add_tech("Spear","spear");
$cl_techs->set_group("Infantry");
...
$cl_techs->add_tech("Scout","spy");
$cl_techs->set_group("Cavalry");
...
$cl_techs->add_tech("Light cavalry","light");
$cl_techs->set_group("Cavalry");
...
if($config['archers']){
$cl_techs->add_tech("Mounted archer","marcher");
$cl_techs->set_group("Cavalry");
...
$cl_techs->add_tech("Heavy cavalry","heavy");
$cl_techs->set_group("Cavalry");
...
$cl_techs->add_tech("Ram","ram");
$cl_techs->set_group("Siege weapons");
...
$cl_techs->add_tech("Catapult","catapult");
$cl_techs->set_group("Siege weapons");
$cl_techs->set_woodprice("640","1.6");
