		...
		<tr>
			<td valign="top">
				<table class="vis">
					...
					<tr>
						<td>
							<img src="{$config.cdn}/graphic/icons/wood.png" title="Wood" alt="" />
					...
					<tr>
						<td>
							<img src="{$config.cdn}/graphic/icons/stone.png" title="Clay" alt="" />
					...
					<tr>
						<td>
							<img src="{$config.cdn}/graphic/icons/iron.png" title="Iron" alt="" />
...
<table class="vis" width="100%">
	...
	<tr>
		<td>{if $arr.type=='to'}Transport to {else}Return from {/if}<br /><a href="game.php?village={$village.id}&amp;screen=info_village&amp;id={$arr.villageid}">{$arr.villagename}</a></td>
		<td>{if $arr.wood > 0}<img src="{$config.cdn}/graphic/icons/wood.png" title="Wood" alt="" />{$arr.wood} {/if}{if $arr.stone > 0}<img src="{$config.cdn}/graphic/icons/stone.png" title="Clay" alt="" />{$arr.stone} {/if}{if $arr.iron > 0}<img src="{$config.cdn}/graphic/icons/iron.png" title="Iron" alt="" />{$arr.iron} {/if}</td>
		<td>{$arr.dealers}</td>
		<td>{$arr.duration}</td>
		<td>{$arr.arrival}</td>
...
{/if}
{if count($others) > 0}
<h3>Incoming transports</h3>
<table class="vis" width="100%">
	<tr>
		<th width="160">Origin</th>
		{if $others_see_ress}
		<th width="80">Merchants</th>
		{/if}
		<th width="100">Arrival</th>
		<th width="70">Arrival in</th>
	</tr>
