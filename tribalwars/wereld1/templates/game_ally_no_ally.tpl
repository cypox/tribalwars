...
{/if}
<p>Here you can join a tribe, or create your own tribe.</p>
<form action="game.php?village={$village.id}&amp;screen=ally&amp;action=create&amp;h={$hkey}" method="post">
	<table class="vis" width="400">
		...
		<tr><td>Tag:<br />(maximum 6 characters)</td><td align="center"><input type="text" name="tag" maxlength="6" /></td></tr>
		<tr><th colspan="2"><div align="right"><input type="submit" value="FOUND TRIBE" class="button" /></div></th></tr>
	</table><br />
</form>
<table class="vis" width="400">
	<tr><th colspan="3">Invitations</th></tr>
