...
$connect = mysqli_connect($mysql_host,$mysql_user,$mysql_pw,$mysql_db);
$drop = mysqli_query($connect, " DROP TABLE IF EXISTS awards ");
$create = mysqli_query($connect, " CREATE TABLE awards (
